...
export default function AgentChat() {
  ...
  return (
    <div className={`flex flex-col bg-slate-900 border border-slate-700 rounded-xl overflow-hidden shadow-2xl transition-all duration-300 ${isExpanded ? 'fixed bottom-4 right-4 w-[600px] h-[800px] z-[9999]' : 'h-[500px]'}`}>
